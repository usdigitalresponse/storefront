...
export default function Home () {
  return (<Provider store={store}>
    <section aria-label="Introduction" id="hero">
      <div className="usa-hero" style={{ backgroundImage: `url('https://dl.airtable.com/.attachments/3f876aa40d6e0dd6fd22edbf71d00232/83133c8b/bg3.jpg')` }}>
        <div className="grid-container">
          <div className="usa-hero__callout">
            ...
            <p><a className="usa-button" href="/boxes">Order a Box</a></p>
            <p><a className="usa-button" href="/drive">Drive or Distribute</a></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="usa-section usa-section--dark">
      <div className="grid-container">
        ...
        <p><a className="usa-button usa-button--big" href="/request">Request a delivery</a></p>
      </div>
    </section>
    <section className="grid-container usa-section" id="currently_serving">
      <div className="grid-row grid-gap">
        ...
        <div className="tablet:grid-col-8 usa-prose">
          ...
          <div>
            <Interweave content={"We are working with wholesalers and volunteers in Bexar County / San Antonio, Texas"} />
          </div>
        </div>
      </div>
    </section>
